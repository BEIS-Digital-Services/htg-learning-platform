namespace Beis.LearningPlatform.Data.Repositories.Base
{
    ...
    public class FeedbackGenericRepository<TEntity> : IFeedbackGenericRepository<TEntity> where TEntity : FeedbackEntity
    {
        protected readonly DataContext context;
        private DbSet<TEntity> entities;

        public FeedbackGenericRepository(DataContext context)
        {
        ...
        /// <summary>
        /// Get all entities using paging from database async
        /// </summary>
        /// <param name="page">zero based page index</param>
        /// <param name="size">size of page</param>
        /// <returns>IEnumerable<TEntity></returns>
