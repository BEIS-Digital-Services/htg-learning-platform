...
namespace Beis.LearningPlatform.Web.Controllers
{
    ...
    /// </summary>
    public class SkillsOneController : ControllerBase
    {
        private const string cSESSION_EMAIL_ANSWER = "skills1_emailAnswer";
        private const string cSESSION_DIAGNOSTIC_TOOL_FORM = "skills1_Form";
        ...
        private async Task<DiagnosticToolForm> TryGetSessionForm()
        {
            ...
            {
                var createFormResponse = await _controllerHelper.CreateForm(FormTypes.SkillsOne);
